...
import 'package:dart_bio_seqio/src/seqio/infrastructure/core/locus/locus_dto.dart';
import 'package:dart_bio_seqio/src/seqio/infrastructure/genbank/locus/genbank_locus_event.dart';
...
void main() {
  group('From Genbank file |', () {
    ...
    setUpAll(() {
      locusDto = LocusDto(GenbankLocusEvent());
    });
    ...
    test('Should get locus data (Locus entity)', () {
      ...
      final locus = locusDto!.fromFile(
        locusList: [locusGenbank],
